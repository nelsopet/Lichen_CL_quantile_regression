############################################################################################################################################
#Abundance of Matrix Lichen vs Nitrogen in the Eastern US
################################################################################################################
...
XVAR_names<-c("N","N_poly","N_poly2","N_poly3","N_clim","N_poly_clim","clim","N_maxaug_c","N_mindec_c","N_precip_cm","N_continen","N_CMD", "Max C Aug Temp","Min C Dec Temp","Precip_cm","Continentality","CMD");
...
pdf(paste("Abn_Mtx_sum34_max4_N_Lichen_Abundance_vs_N_percentiles_East","_",format(Sys.time(),"%y%d%m"),".pdf",sep=""))
  ...
  
{
  ...
  plot(Abn_Mtx_sum34_max4~N, data=SOURCE, xlab="CMAQ N kg/ha/yr", ylab="Abundance Abn_Mtx_sum34_max4 Lichens", main="Abundance of Abn_Mtx_sum34_max4 \n lichen species vs N deposition", col=Area)
  ...
  legend('topright', legend=c("Raw Data East", "Fitted Values", "Prediction Interval"), col=c("darkorange","black","blue"), pch=16)
...
################################################################################################################
#Abundance of Matrix Lichens vs sulphur deposition in the Eastern US
################################################################################################################
...
#	#legend('topright', legend=c("Raw Data East","Raw Data West", "Fitted Values Deposition only", "95% Bootstrapped Confidence Interval Deposition only","Fitted Values Climate + Deposition","0/10/20/50/80% loss"), col=c("darkorange","darkgreen","blue", "black","grey","red"), pch=16, cex=1)
#	dev.off()
pdf(paste("Abn_Mtx_sum34_max4_Lichen_Abundance_vs_S_percentiles_East","_",format(Sys.time(),"%y%d%m"),".pdf",sep=""))
  ...
  
{
  ...
  SOURCE_S_fPlot<-subset(SOURCE_S_fPlot, S < 20)
  plot(Abn_Mtx_sum34_max4~S, data=SOURCE, xlab="CMAQ S kg/ha/yr", ylab="Abundance Abn_Mtx_sum34_max4 Lichens", main="Abundance of  Abn_Mtx_sum34_max4 lichen species vs S deposition", col="darkorange")
  points(SOURCE_S_fPlot$S, SOURCE_S_fPlot$fit, col='blue', pch= 19)
  points(SOURCE_S_fPlot$S, SOURCE_S_fPlot$low,  col='black', pch= 4, cex=0.25) 
  points(SOURCE_S_fPlot$S, SOURCE_S_fPlot$high, col='black', pch= 4, cex=0.25)	
  ...
  legend('topright', legend=c("Raw Data East", "Fitted Values", "Prediction Interval"), col=c("darkorange","darkgreen","black","blue"), pch=16)
