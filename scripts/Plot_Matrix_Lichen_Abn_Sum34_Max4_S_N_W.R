############################################################################################################################################
#Abundance of Matrix Lichen vs Nitrogen in the Western US
################################################################################################################
...
pdf(paste("Abn_Mtx_sum34_max4_N_Lichen_Abundance_vs_N_percentiles_West","_",format(Sys.time(),"%y%d%m"),".pdf",sep=""))
  ...
  
{
  ...
  legend('topright', legend=c("Raw Data West", "Raw Data West", "Fitted Values", "Prediction Interval"), col=c("darkorange","darkgreen","black","blue"), pch=16)
...
################################################################################################################
#Abundance of Matrix Lichens vs sulphur deposition in the Western US
################################################################################################################
  ...
  
{
  ...
  SOURCE_S_fPlot<-subset(SOURCE_S_fPlot, S < 20)
  palette(c("darkorange","darkgreen"))
  plot(Abn_Mtx_sum34_max4~S, data=SOURCE, xlab="CMAQ S kg/ha/yr", ylab="Abundance Abn_Mtx_sum34_max4 Lichens", main="Abundance of  Abn_Mtx_sum34_max4 lichen species vs S deposition", col=Area)
  points(SOURCE_S_fPlot$S, SOURCE_S_fPlot$fit, col='blue', pch= 19)
  points(SOURCE_S_fPlot$S, SOURCE_S_fPlot$low,  col='black', pch= 4, cex=0.25) 
  points(SOURCE_S_fPlot$S, SOURCE_S_fPlot$high, col='black', pch= 4, cex=0.25)	
